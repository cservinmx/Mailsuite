...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			Mailbox
			<small><?= imap_num_msg ($imapResource); ?> messages</small>
		</h1>
		<ol class="breadcrumb">
...
<section class="content">
	<div class="row">
		...
		<?php if($imapResource === false){
		  ...
		  ?>
		<div class="col-md-3">
			<a href="compose.html" class="btn btn-primary btn-block margin-bottom">Nuevo correo</a>
					...
					<div class="table-responsive mailbox-messages">
						<table id="results"  class="table table-bordered">
							...
							<tr>
								...
								echo htmlentities($overview->subject); ?> </td>
