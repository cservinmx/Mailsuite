...
session_start();
  ...
  if(isset($_POST['user']) && isset($_POST['password'])){
    //header('Location: index.php');
      ...
      include_once __DIR__.'/afterlogic/libraries/afterlogic/api.php';
    	...
    	if (class_exists('CApi') && CApi::IsValid()){
          ...
          $_SESSION['user']=base64_encode($sEmail);
          $_SESSION['pass']=base64_encode($sPassword);
    			if ($oAccount){
    				...
    				// login error
    				$error=$oApiIntegratorManager->GetLastErrorMessage();
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Legal</b>TR</a>
  </div>
  <!-- /.login-logo -->
