...
<head>
  ...
  <title>..:: LegalTracking Mail Dashboard ::..</title>
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php if($oCollection->MessageUnseenCount>0){ echo $oCollection->MessageUnseenCount; } ?></h3>
              <p>Correos Nuevos</p>
            </div>
            <div class="icon">
              <i class="fa fa-envelope-o"></i>
            </div>
            <a href="<?= BASE_URL; ?>correo/mailbox.php" class="small-box-footer">Ver correos <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
